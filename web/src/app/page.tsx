        ...
        <header className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="flex items-center gap-2 rounded-full border border-zinc-700 bg-zinc-950/50 px-4 py-2 text-sm text-zinc-300 transition hover:border-zinc-500 hover:text-white"
            >
